...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
            ...
            <form method="POST" action="{{route('teacher.login.submit')}}" class="login100-form validate-form p-l-55 p-r-55 p-t-178">
                @csrf
                <span class="login100-form-title" style="font-family: 'Ubuntu', sans-serif;background-color:#57b846">
                    ...
                    <p style='color:green;text-align:center'><b>Your account is Approved</b></p>
                    <p style='color:green;text-align:center'>You can login now.</p></br>
                    @endif
					...
					<div class="flex-col-c p-t-70 p-b-40">
						...
						<a href="{{route('teacher.register')}}" class="txt3">
							Sign up now
						</a>
					</div>
				</form>
